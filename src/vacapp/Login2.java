...
public class Login extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        try {
            //***RP CHANGE**** == only works for primitive data types .equals works for objects like string
            if (userExist(txtUsuario.getText()).equals("false")) {
                counterFalses = 0;
                JOptionPane.showMessageDialog(null, "Usuario incorrecto");
            } else {
                if (consultingUserBlock(txtUsuario.getText())) {
                    JOptionPane.showMessageDialog(null, "Usuario Bloqueado");
                } else {
                    if (passCorrect(txtPassword.getText()).equals("false")) {
                        counterFalses++;
...
//    }
    ...
    private void userType (String user){
        try{
            Connection connection = conectorSQL.getInstance().getConnection();
            ...
            ///HERE GOES ADMINVIEW
                ...
                System.out.println("Type is not between 0,1,2");
            }
        }catch (SQLException e){
            System.out.println("Error with userType sql "+ e.getMessage());
            e.printStackTrace();
        }
